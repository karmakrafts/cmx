...
macro(app_compile_definitions)
    if(DEFINED APP_BINARY_TARGET)
        target_compile_definitions(${APP_BINARY_TARGET} PUBLIC ${ARGN})
    endif()
    if(DEFINED APP_STATIC_TARGET)
        target_compile_definitions(${APP_STATIC_TARGET} PUBLIC ${ARGN})
    endif()
    if(DEFINED APP_TEST_TARGET)
        target_compile_definitions(${APP_TEST_TARGET} PUBLIC ${ARGN})
    endif()
endmacro()