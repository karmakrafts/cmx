...
macro(app_include_directories visibility)
    if(DEFINED APP_BINARY_TARGET)
        target_include_directories(${APP_BINARY_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED APP_STATIC_TARGET)
        target_include_directories(${APP_STATIC_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED APP_TEST_TARGET)
        target_include_directories(${APP_TEST_TARGET} ${visibility} ${ARGN})
    endif()
endmacro()
...
macro(app_compile_definitions visibility)
    if(DEFINED APP_BINARY_TARGET)
        target_compile_definitions(${APP_BINARY_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED APP_STATIC_TARGET)
        target_compile_definitions(${APP_STATIC_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED APP_TEST_TARGET)
        target_compile_definitions(${APP_TEST_TARGET} ${visibility} ${ARGN})
    endif()
endmacro()
