...
# CTRE
set(CL_CTRE_VERSION 3.7.2)
set(CL_CTRE_FETCHED OFF)

macro(target_include_ctre target)
    if (NOT CL_CTRE_FETCHED)
        FetchContent_Declare(
                ctre
                GIT_REPOSITORY https://github.com/hanickadot/compile-time-regular-expressions.git
                GIT_TAG "v${CL_CTRE_VERSION}")
        FetchContent_MakeAvailable(ctre)
        set(CL_CTRE_FETCHED ON)
    endif ()

    target_include_directories(${target} PUBLIC ${CL_DEPS_DIR}/ctre-src/include)
endmacro()
