...
macro(lib_compile_definitions)
    if(DEFINED LIB_STATIC_TARGET)
        target_compile_definitions(${LIB_STATIC_TARGET} PUBLIC ${ARGN})
    endif()
    if(DEFINED LIB_SHARED_TARGET)
        target_compile_definitions(${LIB_SHARED_TARGET} PUBLIC ${ARGN})
    endif()
    if(DEFINED LIB_TEST_TARGET)
        target_compile_definitions(${LIB_TEST_TARGET} PUBLIC ${ARGN})
    endif()
endmacro()