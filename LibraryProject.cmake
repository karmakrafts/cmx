...
macro(lib_include_directories visibility)
    if(DEFINED LIB_STATIC_TARGET)
        target_include_directories(${LIB_STATIC_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED LIB_SHARED_TARGET)
        target_include_directories(${LIB_SHARED_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED LIB_TEST_TARGET)
        target_include_directories(${LIB_TEST_TARGET} ${visibility} ${ARGN})
    endif()
endmacro()
...
macro(lib_compile_definitions visibility)
    if(DEFINED LIB_STATIC_TARGET)
        target_compile_definitions(${LIB_STATIC_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED LIB_SHARED_TARGET)
        target_compile_definitions(${LIB_SHARED_TARGET} ${visibility} ${ARGN})
    endif()
    if(DEFINED LIB_TEST_TARGET)
        target_compile_definitions(${LIB_TEST_TARGET} ${visibility} ${ARGN})
    endif()
endmacro()
